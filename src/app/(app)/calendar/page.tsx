  ...
  return (
    <section className="space-y-6">
      <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
        ...
        <a href="/appointments/new" className="rounded-xl bg-slate-900 px-4 py-2 text-sm font-medium text-white">Book appointment</a>
      </div>
              ...
              return (
                <li key={appointment.id} className="grid gap-2 p-4 sm:grid-cols-[120px_1fr_160px] sm:items-center">
                  ...
                  <div>
                    ...
                    <div className="mt-1 text-xs text-slate-400">{sentReminders} sent reminders · {failedReminders} failed</div>
                  </div>
                  <span className="rounded-full bg-slate-100 px-3 py-1 text-center text-xs font-medium text-slate-700">{appointment.status}</span>
                </li>
              );
            })}
          </ul>
